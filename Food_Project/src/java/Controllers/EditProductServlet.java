 ...
 * @author Fpt
 */
// Servlet đảm nhận việc lấy dữ liệu chi tiết sản phẩm và các thông tin liên quan để hiển thị ra form chỉnh sửa
// Khi người quản trị bấm nút Edit, servlet này sẽ lấy dữ liệu và forward sang EditProduct.jsp
...
public class EditProductServlet extends HttpServlet {
    ...
    @Override
    /**
 * Khi người quản trị bấm nút Edit ở danh sách sản phẩm:
 * - Servlet này nhận id sản phẩm, lấy thông tin chi tiết sản phẩm, danh mục, review...
 * - Đưa các thông tin đó vào request attribute
 * - Forward sang EditProduct.jsp để hiển thị form chỉnh sửa với dữ liệu đã được điền sẵn
 */
